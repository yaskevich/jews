    ...
    function (L, wms) {
        ...
        function createMap(div, tiled) {
            ...
            var source = wms.source(
                ...
                "https://geodata.lib.harvard.edu/mapimages_public/wms",
                {
                    "format": "image/png",
                    "transparent": "true",
                    "attribution": "<a href='https://library.harvard.edu/services-tools/harvard-geospatial-library'>Harvard Geospatial Library</a>",
        ...
        function basemap() {
            // maps.stamen.com
            var attr = '<a href="http://openstreetmap.org">OpenStreetMap</a>';
            return L.tileLayer(
